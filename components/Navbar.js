      ...
      <Fade>
        <div className="z-20 mobile-menu-items hidden h-screen w-screen bg-light-blue fixed mobile-menu-items lg:hidden">
          <div className="flex flex-col gap-y-5 ml-5 text-lg mt-16">
            ...
            <Link href="/#activity-section" passHref><div onClick={handleMenuButtonClick} className="hover:text-orange font-medium text-black tracking-widest cursor-pointer transition duration-300">KAMPUNG JAWA</div></Link>
